...
%     saveas(gcf,strcat(figdir,opslaan_als),'png');
    ...
    if equalize && strcmp(method,'TSP')
        ...
        b_dB=b_dB+w_use*ones(1,41)+abs(mean(w_use));
        ...
        opdracht=['save ' naam_telefoon '_' phi_naam '_irdB.mat ' naam_telefoon '_' phi_naam '_irdB; clear ' naam_telefoon '_' phi_naam '_irdB;'];
        eval(opdracht);
