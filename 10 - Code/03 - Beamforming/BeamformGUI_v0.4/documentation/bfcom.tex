...
\setlength{\itemsep}{-1ex}
   ...
   \item Methods
   \item Constructor
   \item New Samples Available Function
   \item New Connection Function
   \item Lost Connection Function
   \item Face Up Function
   \item Is Moving Function
   \item Orientation Change Function
   \item ID2phone Function
\end{itemize}
\begin{verbatim}
...
disp(locs\{1\});\end{verbatim}


\subsection*{Example 2}

\begin{verbatim}s = bfcom;s.phones(2) = s.phones(1); s.phones(3) = s.phones(1);s.phones(2).phoneID = 'ID2';s.phones(3).phoneID = 'ID3';s.ID2phone('ID2')
s.newSamplesAvailable([[1 2 3 4];[9 8 7 6]], \{'ID1' 'ID2'\})
s.newConnection('ID99',1,2*pi)
s.orientationChange('ID99', pi, pi/2)
s.lostConnection('ID99')\end{verbatim}
...
\subsection*{New Samples Available Function}
...
\subsection*{New Connection Function}
...
\subsection*{Lost Connection Function}
...
\subsection*{Orientation Change Function}
