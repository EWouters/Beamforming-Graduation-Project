...
%             assignin('base','obj',obj)
        ...
        function pbUpdate_Callback(obj,~,~)
            ...
            if obj.UI.ListAvailable.Value > size(obj.MainObj.DataBuffer.ChanNames,2) && size(obj.MainObj.DataBuffer.ChanNames,2)
                obj.UI.ListAvailable.Value = size(obj.MainObj.DataBuffer.ChanNames,2);
            end
            if obj.UI.ListConnected.Value > size(obj.ChanNames,2) && size(obj.ChanNames,2)
