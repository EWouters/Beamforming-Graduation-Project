classdef intelligibility_ui < handle
    % INTELLIGIBILITY_UI Holds the gui elements for the intelligibility panel
    %
    %   INTELLIGIBILITY_UI() create ui in new figure
    %   INTELLIGIBILITY_UI(PARENT) create ui in parent panel
    %   INTELLIGIBILITY_UI(PARENT, MAINOBJ) create ui with handle to main object
    %
    % Example 1:
    %   obj = intelligibility_ui
    %
    % Example 2:
    %   Parent = figure
    %   obj = intelligibility_ui(Parent)
    %
    % INTELLIGIBILITY_UI Methods:
    %   intelligibility_ui       - Constructor
    ...
    properties
        ...
        Name = 'Intelligibility'; % Name of UI
...
%             assignin('base','obj',obj)
        ...
        function pbUpdate_Callback(obj,~,~)
            ...
            if obj.MainObj.DataBuffer.IsInitialized
                ...
                obj.Lines = [];
                warning('intelligibility_ui:Buffer not initialized')
            end
        end
...
%             disp('Update recieved')
        ...
        function UI = graphicsCode(obj)
            ...
            UI.cbContinuousUpdate = uicontrol(obj.Parent,'Style','checkbox',...
                'String','Continuous Update','Value',0,'Callback',@obj.cbContinuousUpdate_Callback,...
