    ...
    methods
        ...
        function ChansChanged_Callback(obj,~,cbd)
            if obj.UI.PopupFirstChan.Value > obj.UI.PopupLastChan.Value
                ...
                obj.nChan = obj.UI.PopupLastChan.Value - obj.UI.PopupFirstChan.Value;
            end
        end
