...
%% Source Settings Selection UI Class
    ...
    methods
        ...
        function obj = source_settings_ui(varargin)
            ...
            ButtonGroup1 = uibuttongroup(obj.Parent,'Position',grid2pos([0,2, 1,1, 1,3]),...
            ...
            for ii = 1:n
                uicontrol(ButtonGroup1,'Style','radiobutton',...
                    ...
                    'Position',grid2pos([0,n-ii, 1,1, 1,n, 0,0.1]),...
                    'Tag',mat2str(ii));
                obj.UI{ii}.Panel = uipanel(obj.Parent,'Position',grid2pos([0,0, 1,2, 1,3]),...
