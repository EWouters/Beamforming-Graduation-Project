...
%                     end
                ...
                case 'Save Plot Data as .mat'
                    obj.MainObj.DataBuffer.FileName = [];
                    firstSample = ceil(max(1,obj.MainObj.UI.PlotWindow.Axes{1}.XLim(1)*obj.MainObj.DataBuffer.Fs));
                    lastSample = floor(min(obj.MainObj.DataBuffer.TotalSamples,obj.MainObj.UI.PlotWindow.Axes{1}.XLim(2)*obj.MainObj.DataBuffer.Fs));
