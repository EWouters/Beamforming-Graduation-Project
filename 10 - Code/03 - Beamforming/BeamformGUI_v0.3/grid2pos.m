...
function pos = grid2pos(grid1)
    % Format:
    % [x,y, xLen,yLen, xSize,ySize, l,b,r,t, xSpace,ySpace]
%     grid1 = [1,1, 2,1, 2,2];
    ...
    width  = (xUnit + xSpace)*xLen-xSpace;
    height = (yUnit + ySpace)*yLen-ySpace;
    left   = pos(7) +xSpace+ x*(xUnit+xSpace);
    bottom = 1-(pos(8)+ySpace+ y*(yUnit+ySpace))-height;
