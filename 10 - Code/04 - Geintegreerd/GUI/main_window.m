...
%             UI.BeamPatterns = beam_patterns_ui(UI.Plots.Tabs{3},obj);
            % Create Settings Panel
            UI.Settings = std_panel(UI.MainFig, grid2pos([1,1,1,1,3,2]),'Input Channels',{'Sources','Locations','Beamformers','Intelligibility','Plot Settings','Save Data'});
            % Add sources panels
            UI.Sources = std_panel(UI.Settings.Tabs{1}, grid2pos([]),'Sources',{'Smartphones','Simulation','Computer Mic','Load File'});
            ...
            % Add Save File panel
            UI.SaveFile = save_file_settings_ui(UI.Settings.Tabs{6},obj);
